...
class AppColors {
  static const Color primary = Color(0xff193751);
  static const Color darkModePrimary = Color(0xffFFFFFF);
  ...
  static const Color lightBlue = Color(0xff43739D);
  ...
  static const Color serviceColor1 = Color(0xFFBFCED2);
  static const Color serviceColor2 = Color(0xFFBFCED2);
  static const Color serviceColor3 = Color(0xFFBFCED2);
}
