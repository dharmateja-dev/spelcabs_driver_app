          ...
          return Scaffold(
            ...
            body: Stack(
              children: [
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: GoogleFonts.poppins(
                          color: themeChange.getThem() ? Colors.grey : Colors.grey,
                        ),
                        prefixIcon: Icon(
                          Icons.search,
                          color: themeChange.getThem() ? Colors.grey : Colors.grey,
                        ),
                        suffixIcon: Obx(() => controller.searchTxtController.value.text.isNotEmpty
                            ? IconButton(
                ...
                // Search suggestions
                Obx(() => controller.showSuggestions.value && controller.suggestionsList.isNotEmpty
                    ? Positioned(
                  top: 80,
                  left: 10,
                  right: 10,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          leading: Icon(
                            ...
                            color: themeChange.getThem() ? Colors.grey : Colors.grey[600],
                          ),
                          title:                                 Text(
                            suggestion.address?.toString() ?? 'Unknown location',
                            style: GoogleFonts.poppins(
                              color: themeChange.getThem() ? Colors.white : Colors.black,
                              fontSize: 14,
                            ),
                          ...
                          onTap: () {
                            controller.selectLocationFromSuggestion(suggestion);
                          },
                        );
                      },
                    ),
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      return Transform.translate(
                        offset: Offset(0, (1 - controller.animation.value) * 200),
                        child: Container(
                          decoration: BoxDecoration(
                            color: themeChange.getThem() ? AppColors.darkContainerBackground : Colors.white,
