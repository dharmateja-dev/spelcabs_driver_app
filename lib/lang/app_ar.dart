const Map<String, String> arAR = {
  ...
  "Sign up":"التسجيل",
  "Create your account to start using GoRide":"أنشئ حسابك للبدء في استخدام جو رايد",
  ...
  "Note : Admin commission will be debited from your wallet balance. \n Admin commission will apply on Ride Amount minus Discount(if applicable).":    "ملاحظة: سيتم خصم عمولة الإدارة من رصيد محفظتك. \n سيتم تطبيق عمولة الإدارة على قيمة الرحلة ناقص الخصم (إذا كان موجودًا).",
  ...
  "You can not change once you select one service type if you want to change please contact to administrator": "لا يمكنك التغيير بمجرد اختيارك نوع الخدمة، إذا كنت تريد التغيير يرجى الاتصال بالإدارة",
