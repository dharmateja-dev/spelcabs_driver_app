                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // MercadoPago
                                if (controller.paymentModel.value.mercadoPago
                                        ?.enable ==
                                    true)
                                  _buildPaymentOption(
                                    context1,
                                    ...
                                    paymentName: controller
                                        ...
                                        .toString(),
                                    imagePath: 'assets/images/mercadopago.png',
                                  ),

                                // FlutterWave
                                if (controller.paymentModel.value.flutterWave
                                        ?.enable ==
                                    true)
                                  _buildPaymentOption(
                                    context1,
                                ...
                                if (controller
                                  ...
                                  _buildPaymentOption(
                                    ...
                                    paymentName: controller
                                        ...
                                        .toString(),
                                    imagePath: 'assets/images/paytam.png',
                                  ),

                                // Razorpay
                                if (controller
                                        .paymentModel.value.razorpay?.enable ==
                                    true)
                                  _buildPaymentOption(
                                    context1,
                                    themeChange,
                                ...
                                // Midtrans
                                if (controller
                                        .paymentModel.value.midtrans?.enable ==
                                    true)
                                  _buildPaymentOption(
                                    context1,
                                    themeChange,
                                    ...
                                    paymentName: controller
                                        ...
                                        .toString(),
                                    imagePath: 'assets/images/midtrans.png',
                                  ),
                                ...
                                if (controller
                                  ...
                                  _buildPaymentOption(
                                    ...
                                    paymentName: controller
                                        ...
                                        .toString(),
                                    imagePath: 'assets/images/xendit.png',
                                  ),

                                // OrangePay
                                if (controller
                                        .paymentModel.value.orangePay?.enable ==
                                    true)
                                  _buildPaymentOption(
                                    context1,
                                    themeChange,
                                ...
                                // PhonePe
                                if (controller
                                        .paymentModel.value.phonePe?.enable ==
                                    true)
                                  _buildPaymentOption(
                                    context1,
                                    themeChange,
                                    controller,
                                    paymentName: controller
                                        .paymentModel.value.phonePe!.name
                                        .toString(),
                                    imagePath: 'assets/icons/ic_phonepe.png',
                                    isPhonePe: true,
                                  ),
                              ],
                            ),
                      ...
                      ButtonThem.buildButton(context, title: "Topup".tr,
                        ...
                        if (selectedMethod ==
                          ...
                          controller.xenditPayment(context, amount);
                            ...
                            controller.paymentModel.value.phonePe?.name) {
                          controller.phonePeMakePayment(amount: amount);
                        } else if (selectedMethod ==
                          ...
                          RazorPayController()
                            ...
                            if (value == null) {
                              ...
                              controller.openCheckout(
                                  amount: amount, orderId: value.id);
                            }
                          });
                        }
                      }),
      ...
      children: [
        ...
        InkWell(
          onTap: () {
            ...
            // For PhonePe, trigger payment immediately
            if (isPhonePe &&
                controller.amountController.value.text.isNotEmpty) {
              Get.back();
              controller.phonePeMakePayment(
