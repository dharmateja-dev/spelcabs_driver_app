...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<HomeController>(
        ...
        builder: (controller) {
          // Check if driver registered with freight vehicle
          final bool isFreightDriver =
              controller.driverModel.value.vehicleInformation != null &&
                  controller.driverModel.value.vehicleInformation!
                          .freightVehicleId !=
                      null &&
                  controller.driverModel.value.vehicleInformation!
                      .freightVehicleId!.isNotEmpty;
          ...
          return Scaffold(
            ...
            bottomNavigationBar: isFreightDriver
                ? null
                : BottomNavigationBar(
