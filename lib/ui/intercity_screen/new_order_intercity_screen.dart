                        ...
                        child: Column(
                          children: [
                            ...
                            ButtonThem.buildButton(
                              ...
                              title: "Search".tr,
                              onPress: () {
                                // Validate that both source and destination are entered
                                if (controller.sourceCityController.value.text
                                    .trim()
                                    .isEmpty) {
                                                ...
                                                if (orderModel
                                                  ...
                                                  controller.newAmount.value =
                                                      orderModel.offerRate
                                                          .toString();
                                                  // Parse time string (accept 'hh:mm a' or 'HH:mm') and format to 12-hour
                                                  DateTime start;
                                                  try {
                                                    start = Constant
                                                        .parseTimeString(
